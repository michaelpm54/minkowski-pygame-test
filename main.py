...
# Minkowski collision detection specifies that if a point is colliding with
# 0,0, it is is colliding with the other object
...
def start():
	...
	controls_info_0 = font.render('Left click - Toggle arrow controls', True, (235, 182, 250))
	controls_info_1 = font.render('Right click - Toggle minkowski geometry', True, (235, 182, 250))
	controls_info_2 = font.render('q - Quit', True, (235, 182, 250))
	...
	while run:
		...
		screen.blit(controls_info_0, (25, 485))
		screen.blit(controls_info_1, (25, 525))
		screen.blit(controls_info_2, (25, 565))
